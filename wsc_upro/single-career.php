...
<section class="block-text">
	<div class="container-fluid">
		<?php echo $paragraph ? substr(get_field('description'), strlen($paragraph) + 1) : get_field('description') ?>
	...
	<section class="block-share">
		<div class="container-fluid">
			<div class="block-inner">
				...
				<!-- <ul>
					<li class="fade-up">
						<a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo get_permalink() ?>" class="btn btn-outline-secondary" target="_blank">
					...
					<li class="fade-up">
						<a href="https://twitter.com/intent/tweet?url=<?php echo get_permalink() ?>&text=" class="btn btn-outline-secondary" target="_blank">
					...
					<li class="fade-up">
						<a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo get_permalink() ?>" class="btn btn-outline-secondary" target="_blank">
					...
					<li class="fade-up">
						<a href="https://wa.me/<?php echo get_field('whatsapp_1', 'option') ?>" class="btn btn-outline-secondary" target="_blank">
							<svg width="23" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<li class="fade-up">
						<a href="mailto:<?php echo get_field('email_1', 'option') ?>" class="btn btn-outline-secondary">
					...
					<li class="fade-up">
						<a href="#" class="btn btn-outline-secondary" data-id="copyUrl">
							<?php echo mb_strtoupper(__('Copy link', 'WSC')) ?>
